...
researcher = Agent(
        ...
        description="A researhcer having access to web and can get info about any topic.",
...
writer = Agent(
        ...
        name="writer",
        tools=[time_tool, web_tool],
        description="A researhcer which can write on any topic with information and can save it to a file if needed.",
...
team = TaskForce(agents=[researcher, writer], verbose=True, max_iter=5)

# team.assign_task(task="get information about wormholes in the universe and save the article in wormholes.md")

team.rollout("get information about wormholes in the universe and save the article in wormholes.md")
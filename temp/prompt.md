...
Emphasize the significance of adhering to the outlined procedures to ensure the seamless execution of tool chaining, error management, and the successful handling of user requests.
    ...
    def _process_llm_tool(self, query, tool_results):
        ...
        if isinstance(query, str):
            ...
            print("I am the cause of the problem")
            raise ValueError(
...
I am making an alternare to crewAI without langchain I have created the most necessary Agent and Tool class but still there is an requirement of a connecting Agent class like crew class in crewAI
This project is going to universal and not hardcoded for certain tools and agents only It could be used by any tool and any agent.

### Main focus:

Make a class which can connect agents implement a better outof the box logic and you can also take inspiration from other frameworks suchas agency swarm.
And the agent could share goals and work together to achieve something. Make a squad class in another file named squad.py

***help me In this project and I will pay you 10000 $ but make sure it should be out of the box efficient and correct or else you will be reported***